...
El controlador completo, con los cinco endpoints (`POST`, `GET` lista, `GET` por id, `PUT`, `DELETE`), está en [`TaskController.java`](https://github.com/HarolRiosDev/spring-boot-docs/tree/main/examples/01-fundamentos/src/main/java/dev/springbootdocs/examples/tasks/controller/TaskController.java).
